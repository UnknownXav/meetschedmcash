...
import { ClientBaseType } from "@/lib/types/client.type";
import { deleteClientAccount, updateClientAccount } from "@/lib/services/client.service";

export default function Sample() {
  const { toast } = useToast();
  const [accounts, setAccounts] = useState<ClientBaseType[]>([]);
  const [selectedAccount, setSelectedAccount] = useState<ClientBaseType | null>(null);
  ...
  const handleEdit = (account: ClientBaseType) => {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      await updateClientAccount(selectedAccount.id, {
