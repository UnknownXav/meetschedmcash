...
export default function Reschedule(props: Props) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (date === props.date && time === props.time) {
        toast.error("You doesn't change anything")
        return
      }
      ...
      const resp = await rescheduleMeeting(props.id, payload)
